...
return [
    ...
    */
    ...
    'attributes' => [
        'identification_number' => strtolower(__('Identification number')),
        'last_name'             => strtolower(__('Last name')),
        'name'                  => strtolower(__('Name')),
        'phone'                 => strtolower(__('Phone')),
        'habeas_data'           => strtolower(__('Terms and Conditions')),
        'department_id'         => strtolower(__('Department')),
        'city_id'               => strtolower(__('City')),
    ],
